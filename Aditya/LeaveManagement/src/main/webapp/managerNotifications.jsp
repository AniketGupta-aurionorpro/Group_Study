...
<%
    ...
    List<Leave> leaves = dao.getPendingLeavesForManager(managerId, filterName, filterId);
%>
<html>
<head>
...
<div class="container mt-5">
    <div class="card shadow-sm p-4">
        ...
        <form class="row g-3 mb-4" method="get">
            <div class="col-md-4">
                <input type="text" class="form-control" name="filterName" placeholder="Employee Name"/>
            </div>
            <div class="col-md-4">
                <input type="text" class="form-control" name="filterId" placeholder="Employee ID"/>
            </div>
