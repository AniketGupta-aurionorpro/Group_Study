-- ===================================================
-- Leave Management Database Script
-- ===================================================

DROP DATABASE IF EXISTS leave_managementnoti;
CREATE DATABASE  leave_managementnoti;
USE leave_managementnoti;
...
CREATE TABLE leave_balance (
    ...
    user_id INT,
    year INT,
    paid_leave_taken INT DEFAULT 0,
...
-- ===================================================
INSERT INTO notifications (receiver_id, message, seen)
VALUES
